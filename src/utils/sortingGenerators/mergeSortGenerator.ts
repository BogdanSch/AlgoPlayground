...
export default class MergeSortGenerator extends SortingStepGenerator {
  public constructor(
    displayName: string = "Merge Sort",
    name: string = "mergeSort",
    path: string = "/algorithms/merge",
  ) {
    super(displayName, name, path);
  }
  public generate(numbers: number[]): DivideAndConquerSortStep[] {
  ...
  private mergeSort(
    ...
    this.mergeSort(leftHalf, steps);
    this.mergeSort(rightHalf, steps);
    ...
    this.merge(leftHalf, rightHalf, numbers, steps);
  }
  private merge(
    leftHalf: number[],
    rightHalf: number[],
