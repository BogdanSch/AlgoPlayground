...
const InsertionSortPage: FC = () => {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="array-sort__container">
            <article className="array-sort__article">
              <h1 className="heading">Insertion Sort</h1>
              <p>
              ...
              <ul>
                ...
                <li>
                  <code>i</code> = index for the outer loop (current element
                  being inserted).
                </li>
                <li>
                ...
                <li>
                  <code>tmp</code> = temporarily stores the element that needs
                  to be inserted.
                </li>
              </ul>
              ...
              <p>
                This prevents the value from being overwritten while elements
                are shifted.
              </p>
      ...
      <section className="unplugged">
        <div className="container">
          <div className="unplugged__wrap">
            <h2 className="unplugged__title heading-2">
              See Insertion Sort in Action
            </h2>
            <p className="unplugged__text">
              Understanding algorithms is easier with real-world examples. Watch
              this demonstration to see how Insertion Sort works without code.
            </p>
            <iframe
              className="unplugged__video"
              src="https://www.youtube.com/embed/a-x9_VL6jfY?si=Vci83Rx_5yIUIEBM"
