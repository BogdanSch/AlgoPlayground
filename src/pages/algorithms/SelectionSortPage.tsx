...
const SelectionSortPage: FC = () => {
    return <section>
        ...
        <h2>Explanation:</h2>
          <ul>
                 <li>arr = the list of numbers you want to sort</li> 
                 <li>n = number of elements in arr</li>
                 <li>i = index for the outer loop (marks the boundary between sorted and unsorted part)</li> 
                 <li>j = index for the inner loop (used to search for the smallest element)</li>
            </ul>
        <h3>Outer Loop</h3>
        <p className="CodeExp"><code>Iterate (n - 1) times</code></p>
            ...
            <h3>5. Repeat until all elements are sorted</h3>
            <p>
            Each round selects the next smallest number and places it in the correct position.
            </p>
